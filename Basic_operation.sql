...
-- insert into class_marks value (1,45,65,78);
-- insert into class_marks 
-- values 
-- (2,78,98,88),
-- (3,45,65,85),
-- (4,77,88,99);
...
-- select max(Eng_score) from class_marks;

-- select * from class_marks 
-- where 
-- Math_score >= 60 & hindi_score >= 90;
...
-- it will be check the database is already exist or not -- 
create database if not exists data_science;
...
select count(*) from bank_details;
 ...
 -- Write a query to select the reserved keyword and perform the operation like this -- 
 select `default` from bank_details;

-- Write a query to only show the 5 record inside the bank_details table 
select * from bank_details limit 5;

-- Write a query to show the data that's age is 33 
select * from bank_details 
where age = 33;

-- Write a query to show the records that's age is grater than 50 
select * from bank_details
where 
age >= 60 ;

-- Write a query to show the records that's age is grather than 60 and job is retaired
select * from bank_details 
where 
age >=60 and job = 'retired'; 

-- Write a query to show the records that's education is unknown or marital is single 
select * from bank_details
where
education='unknown' or marital='single'; 

-- Write a query to show the records thats education  is unknown or marital is single and balance is grather then 500
select * from bank_details 
where 
(education='unknown' or marital='single') and balance >=500;

-- Write a query to show the records how many job are avilable in inside the bank_details table 
select distinct job from bank_details;

## Order By keyword using 

-- write a query to show the all record in acending order in according to age columns  
select * from bank_details order by age asc; --  acending order (asc) and decanding order (desc)
 
 ## Assingment question 
--  // With this data try to find out sum of balance 
--  1. try to find out average of balance 
--  2. try to find out Who having a minimum balance 
--  3. try to find out who is having a maximum balance 
--  4. try to prepare a list of all the person who is having loan 
--  5. try to find out average balance for all the people whose job role is admin 
--  6. try to find out a person without job whose age is below 45 
--  7. try to find out a record where education is primary and person is jobless 
--  8. try to find out a record whose bank account is having a negative balance 
--  9. try to find our a record who is not having house at all along with there balance 

# Solution 
-- 1 to continuous maner 
...
select avg(balance) as admin_average_balance from bank_details where job='admin.';
